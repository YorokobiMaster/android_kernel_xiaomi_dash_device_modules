...
def get_overlay_modules_list():
    ...
    if "dash" in DEFCONFIG_OVERLAYS:
        ...
        mgk_64_device_modules.append("drivers/misc/xiaomi/mi_stack/mi_stack.ko")
        mgk_64_device_modules.append("drivers/misc/xiaomi/mi_ubt/mi_ubt.ko")
        mgk_64_device_modules.append("drivers/misc/xiaomi/mi_ubt_test/mi_ubt_test.ko")
        mgk_64_device_modules.append("drivers/misc/xiaomi/crash_module/crash_module.ko")
        mgk_64_device_modules.append("drivers/misc/xiaomi/mi_memory/mi_memory.ko")
