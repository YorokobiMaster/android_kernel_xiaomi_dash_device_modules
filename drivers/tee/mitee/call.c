...
static struct optee_msg_arg *optee_get_msg_arg(size_t num_params)
{
		       ...
		       struct tee_param *param)
{
	...
	msg_arg = optee_get_msg_arg(arg->num_params + 2);
	if (IS_ERR(msg_arg))
		      ...
		      struct tee_param *param)
{
	...
	msg_arg = optee_get_msg_arg(arg->num_params);
	if (IS_ERR(msg_arg))
		return PTR_ERR(msg_arg);
